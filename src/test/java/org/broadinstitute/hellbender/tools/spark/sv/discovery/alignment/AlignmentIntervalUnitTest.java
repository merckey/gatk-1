...
import static org.broadinstitute.hellbender.tools.spark.sv.SVTestUtils.makeDummySequence;
...
public class AlignmentIntervalUnitTest extends GATKBaseTest {
    ...
    public void testConstructionFromSAMRecord(final BwaMemAlignment bwaMemAlignment, final SimpleInterval expectedReferenceInterval, final Cigar expectedCigar,
        ...
        final SAMRecord samRecord = BwaMemAlignmentUtils.applyAlignment("whatever", makeDummySequence(expectedContigLength, (byte)'A'), null, null, bwaMemAlignment, refNames, hg19Header, false, false);
