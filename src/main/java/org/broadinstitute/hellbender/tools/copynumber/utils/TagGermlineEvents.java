...
public class TagGermlineEvents extends GATKTool{
    ...
    public void traverse() {
        ...
        final List<String> finalAnnotations = tumorSimpleAnnotatedGenomicRegionCollection.getAnnotations();
        ...
        final SimpleAnnotatedGenomicRegionCollection finalCollection =
                SimpleAnnotatedGenomicRegionCollection.create(tumorSegments,
                        tumorSimpleAnnotatedGenomicRegionCollection.getSamFileHeader(),
                        finalAnnotations,
                        tumorSimpleAnnotatedGenomicRegionCollection.getContigColumnName(),
                        tumorSimpleAnnotatedGenomicRegionCollection.getStartColumnName(),
                        tumorSimpleAnnotatedGenomicRegionCollection.getEndColumnName());
